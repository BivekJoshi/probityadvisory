...
/** One service summarised; the whole card opens its full write-up. */
export function ServiceCard({ service, index }: { service: Service; index: number }) {
  ...
  return (
    <StaggerItem
      as="article"
      className="group relative flex flex-col rounded-2xl border border-line bg-card p-7 shadow-card transition-[border-color,box-shadow,translate] duration-300 hover:-translate-y-1 hover:border-green/50 hover:shadow-lift"
    >
      ...
      <span
        aria-hidden="true"
        className="mt-auto flex items-center gap-1.5 pt-7 text-[14px] font-medium text-green-ink"
      >
        Read the detail
