...
export const team: Principal[] = [
  {
    ...
    highlights: [
      { value: '3', label: 'Chartered institutes, in India, Nepal and England & Wales' },
      { value: '2019', label: 'First qualified as a Chartered Accountant' },
      { value: 'ICAEW', label: 'Associate Chartered Accountant since 2025' },
    ],
    qualifications: [
      { title: 'CA', body: 'Institute of Chartered Accountants of India', year: '2019' },
      { title: 'CA', body: 'Institute of Chartered Accountants of Nepal', year: '2021' },
      { title: 'ACA', body: 'Institute of Chartered Accountants in England and Wales', year: '2025' },
    ],
    career: [
      {
        when: 'Early career',
      ...
      },
      {
        ...
        detail: 'Qualified with the Institute of Chartered Accountants of India.',
      },
      {
        when: '2021',
        title: 'Chartered Accountant — ICAN',
        detail: 'Qualified with the Institute of Chartered Accountants of Nepal.',
      },
      {
        when: '2025',
        title: 'Associate Chartered Accountant — ICAEW',
        detail: 'Qualified with the Institute of Chartered Accountants in England and Wales.',
      },
      {
        when: 'Today',
        title: 'Principal, his own audit & advisory practice',
        detail: 'Audit, accounting and financial advisory for clients in several sectors in Nepal.',
      },
    ],
    focus: ['Audit', 'Accounting', 'Financial advisory', 'Credit appraisal', 'Financial statement analysis'],
    roles: [
  ...
  },
  {
    ...
    career: [
      ...
      },
      {
        ...
        detail: 'Ran the finance function from inside the business rather than as its adviser.',
      },
      {
        when: 'Past two years',
    ...
    focus: ['Statutory returns', 'Bookkeeping', 'Payroll', 'Accounts finalisation', 'Audit', 'Taxation'],
    sectors: [
      'Trading',
      'Manufacturing',
...
export const findPrincipal = (slug: string | undefined) => team.find((person) => person.slug === slug)
